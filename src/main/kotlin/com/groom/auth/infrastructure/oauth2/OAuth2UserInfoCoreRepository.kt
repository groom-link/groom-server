...
@Repository
internal class OAuth2UserInfoCoreRepository (private val jpaRepository: OAuth2UserInformationJpaRepository,
    ...
    override fun create(authenticationId: Long,
                        data: OAuth2UserInfoCommand.Create): OAuth2UserInfo {
...
internal interface OAuth2UserInformationJpaRepository :
    JpaRepository<OAuth2UserInfoEntity, Long> {
    fun findByProviderNameAndProviderUserId(providerName: OAuth2ProviderName,
                                            providerUserId: String): OAuth2UserInfoEntity?
}